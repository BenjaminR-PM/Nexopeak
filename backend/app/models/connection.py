...
class Connection(Base):
    ...
    scopes = Column(JSONB, default=[], nullable=False)  # OAuth scopes
    status = Column(String(20), default="connected", nullable=False)  # connected, error, revoked
    metadata = Column(JSONB, default={}, nullable=False)  # Provider-specific metadata
    ...
    oauth_tokens = relationship("OAuthToken", back_populates="connection", uselist=False)
